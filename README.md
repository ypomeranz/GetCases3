...
**Side panel** (or press **s**) opens the case‑details panel beside the opinion. In the floating viewer the panel stands in a small window of its own against the viewer’s right‑hand edge (see below); in an ordinary text window it appears inside, taking its width from the opinion.
